...
export const setupMaleMeasurement = (dataSource:DataSource) => {
    ...
    router.get('/:char', measurementController.getActiveMaleMeasurement.bind(measurementController));
    router.get('/:id/:char', measurementController.getMaleMeasurementById.bind(measurementController));
